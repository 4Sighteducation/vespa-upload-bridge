      ...
      const app = createApp({
        ...
        methods: {
          ...
          async startEdit(account) {
            ...
            // Load groups for dropdowns (students only) - always reload to ensure fresh list
            if (this.currentTab === 'students') {
          ...
          async executeBulkGroupUpdate() {
            ...
            if (!confirm(`Update group for ${this.selectedAccounts.length} student(s) to "${this.bulkGroupName}"?`)) {
              return;
            }
            ...
            try {
              ...
              this.showMessage(
                `✅ Bulk group update complete: ${successCount} success, ${failCount} failed`,
                failCount === 0 ? 'success' : 'warning'
              );
            ...
            <div v-if="showBulkGroupUpdateMenu" class="am-modal-overlay" @click.self="showBulkGroupUpdateMenu = false">
              <div class="am-modal am-modal-small">
                ...
                <div class="am-modal-body">
                  ...
                  <div v-if="allStudentGroups.length === 0" style="padding: 16px; background: #fff3cd; border-radius: 6px; color: #856404; margin-top: 12px;">
                    ℹ️ No groups available. Use "Manage Groups" to create groups first.
                  </div>
                </div>
                ...
                <div class="am-modal-footer">
                  ...
                  <button 
                    ...
                    class="am-button primary">
                    Update {{ selectedAccounts.length }} Students
                  </button>
                </div>
              </div>
            </div>
