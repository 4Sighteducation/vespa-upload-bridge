        ...
        methods: {
          ...
          async searchAccounts() {
            ...
            try {
              ...
              const url = `${this.apiUrl}/api/v2/search/${this.accountType}?q=${encodeURIComponent(this.searchQuery)}`;
              ...
              if (data.success) {
                ...
                this.showMessage(`Found ${this.searchResults.length} accounts`, 'success');
              } else {
